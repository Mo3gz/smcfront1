...
import { RotateCcw, Gift, TrendingDown, Shuffle, Swords, Star, HandHelping , Crown } from 'lucide-react';
...
const spinTypes = [
  ...
  { id: 'gamehelper', name: 'Game Helper', cost: 50, icon: HandHelping , color: '#ff6b6b' }, // heart-handshake (using Heart as heart-handshake)
